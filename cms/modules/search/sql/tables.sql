create table sites(
	...
	required text,
	disallowed text,
	can_leave_domain bool) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
create table links (
	...
	level int) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
create table keywords	(
	keyword_id int primary key not null auto_increment,
	keyword varchar(30) not null,
	unique kw (keyword),
	key keyword (keyword(10))) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
create table link_keyword0 (
	...
	domain int(4),
	key linkid(link_id),
	key keyid(keyword_id)) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
create table pending (
	...
	level integer,
	count integer,
	num integer) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
